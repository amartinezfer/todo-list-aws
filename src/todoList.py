    ...
    try:
        ...
        if 'Item' in result:       
            ...
            # Traducir el texto        
                ...
                resultTrans = translate.translate_text(Text=translated_text, SourceLanguageCode=detected_language, TargetLanguageCode=language)
                translated_text =  resultTrans['TranslatedText']
