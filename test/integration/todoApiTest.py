...
class TestApi(unittest.TestCase):
    ...
    def test_api_gettodo_translate(self):
        print('---------------------------------------')
        print('Starting - integration test Get TODO Translate')
        #Add TODO
        url = BASE_URL+"/todos"
        data = {
         "text": "ejemplo"
        ...
        self.assertEqual(
            jsonbody['text'], "ejemplo", "Error en la petición API a {url}"
        )
        #Test GET TODO
        ...
        self.assertEqual(
            json_response['text'], "example", "Error en la petición API a {url}"
        )
        #Delete TODO to restore state
        response = requests.delete(url)
        self.assertEqual(
